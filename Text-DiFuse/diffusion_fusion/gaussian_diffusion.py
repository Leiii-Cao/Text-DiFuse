...
class GaussianDiffusion:
    ...
    @torch.no_grad()
    def p_mean_variance(
        self, diffusion_stage1,diffusion_stage2,Fusion_Control_Model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None,model_kwargs1=None
    ):
        """
    ...
    def training_losses(self, diffusion_stage1,diffusion_stage2, x_start, t, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            feature_hidden_,feature_skip_list_ = diffusion_stage1(x_t, self._scale_timesteps(t), **model_kwargs)
            ...
            if self.model_var_type in [
                ...
                terms["vb"] = self._vb_terms_bpd(
                    diffusion_stage1=lambda *args, r=frozen_out: r,
